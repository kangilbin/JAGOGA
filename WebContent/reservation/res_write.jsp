...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Login Form -->
     <form action="./AdminAddAction.admin" method="post" name="boardform"> 
    	<table>
    	<tr><td><div class="form-group">
	      ...
	      <tr class="fadeIn third"><td>I D</td><td><input type="text" name="id" placeholder="id"></td><tr>
	      <tr><td><input type="button" class="fadeIn fourth" value="예 약" onclick="addboard()"></td><td><input type="reset" class="fadeIn fourth" value="취 소"></td><tr>
	    </table>
	</form>
  </div>
</div>
