<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String roomsName = request.getParameter("roomsName");
%>
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Login Form -->
     <form action="./ClientAddListWindow.bo" method="post"  name="boardform"> 
    	<table>
	      ...
	      <tr class="fadeIn second"><td>TYPE</td>
	     	<td>
	      	<select class="form-control" name="type" style="height:50px;">
				 <option><%= roomsName%></option>

			</select>
	      	</td></tr>
	      <tr><td><input type="button" class="fadeIn fourth" value="예 약" onclick="modify()"></td><td><input type="reset" class="fadeIn fourth" value="취 소" onclick="window.close()"></td><tr>
	    </table>
	</form>
  </div>
</div>
