...
<body style="background-color:#f2f2f2;">
    ...
    <div class="main" style="max-width:768px;min-width: 200px; margin-left:auto; margin-right:auto; height:100%; overflow:auto; background-color: #FFFFFF;">
	  ...
	  <div class="star-check" style="height: 88px; padding: 8px 0; background-color: #FFFFFF; margin:0 20px; border-top:1px solid; border-color:#e6e6e6;">
	   ...
	   <form action="./UserReviewWrite.re" method="post" enctype="multipart/form-data">
	    <div class="make_star">
	    ...
	    <textarea required="required" class="form-control" name="review_content" placeholder="이곳에서 머물렀던 기억을 작성해주세요~" rows="10" cols="40" style="width:50%; height: 100%; margin: 0 20px;"></textarea>
	    <div style="margin:20px 20px;">
	  	...
	  	<input type="hidden" name="rooms_nm" value="${param.rooms_nm}">	
