...
public class MemberDAO 
{
    ...
    public MemberBean getUserInfo(String member_id) 
    {
        ...
        try {
            ...
            query.append("SELECT * FROM MEMBER WHERE MEMBER_ID=?");
    ...
    public int deleteMember(String member_id, String pw) 
    {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            query1.append("SELECT PASSWORD FROM MEMBER WHERE MEMBER_ID=?");
 
            // 회원 삭제
            StringBuffer query2 = new StringBuffer();
            query2.append("DELETE FROM MEMBER WHERE MEMBER_ID=?");
    ...
    public int loginCheck(String member_id, String pw) 
    {
        ...
        try {
            ...
            StringBuffer query = new StringBuffer();
            query.append("SELECT PASSWORD FROM MEMBER WHERE MEMBER_ID=?");
